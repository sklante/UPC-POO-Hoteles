...
public class Clientes {
    ...
    private void simularTabla(){
        this.dbClientes.add(new Cliente("01", "sklante_1@hotmail.com", "123456", "123456"));       
          this.dbClientes.add(new Cliente("02", "alfredo@hotmail.com", "1234", "1234"));
          this.dbClientes.add(new Cliente("03", "ana@hotmail.com", "1234", "1234")); 
    }
