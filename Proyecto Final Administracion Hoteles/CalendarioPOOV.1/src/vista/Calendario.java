...
public class Calendario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnActualizarFact = new javax.swing.JButton();
        ...
        jScrollPane2.setBounds(70, 110, 950, 500);
        ...
        jScrollPane1.setBounds(10, 110, 60, 500);
        ...
        btnActualizarFact.setText("Actualizar");
        btnActualizarFact.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnActualizarFactActionPerformed(evt);
            }
        });

        btnAsignar.setText("Asignar la reserva");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnActualizarFact)
        ...
        tabsFacturacion.addTab("PASAJEROS", jPanel4);
...
//                radBtnOrdenarHabTipo.isSelected());
    ...
    private void btnActualizarFactActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarFactActionPerformed
        limpiarDatos();
    }//GEN-LAST:event_btnActualizarFactActionPerformed
    ...
    private void btnAsignarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAsignarActionPerformed
        ...
        if (conteo == 1) {
            if (asignacionDatos()) {
                ...
                if (JOptionPane.showConfirmDialog(this, "¿Desea asignar los siguientes datos?\n"
                        + clienteSeleccionado) == JOptionPane.OK_OPTION) {
                    switch (tipoClientePaga) {
                        case 1:
                            ControladorHotel.asignarPagador(cbxReservasPreliminar.getSelectedItem().toString(),
                                    ((Empresa) cbxEmpresa.getSelectedItem()),
                                    cbxPersona.getSelectedIndex());
                            limpiarDatos();
                            break;
                        case 2:
                            ControladorHotel.asignarPagador(cbxReservasPreliminar.getSelectedItem().toString(),
                                    ((Agencia) cbxAgencia.getSelectedItem()),
                                    cbxPersona.getSelectedIndex());
                            limpiarDatos();
                            break;
                        case 3:
                ...
                JOptionPane.showMessageDialog(this, "Debes elegir los datos correctamente.", "Aviso de Error", 1);
            }

        } else if (conteo == 0) {
            JOptionPane.showMessageDialog(this, "Debes elegir una persona de facturacion", "Aviso de Error", 1);
        } else if (conteo > 1) {
            JOptionPane.showMessageDialog(this, "No debes seleccionar mas de una persona de facturacion", "Aviso de Error", 1);
        }
    }//GEN-LAST:event_btnAsignarActionPerformed

    public void limpiarDatos() {
        chkEmpresa.setSelected(false);
        chkAgencia.setSelected(false);
        chkPersona.setSelected(false);
        cbxEmpresa.setSelectedIndex(-1);
        cbxAgencia.setSelectedIndex(-1);
        cbxPersona.setSelectedIndex(-1);
        cbxEmpresa.setModel(new javax.swing.DefaultComboBoxModel(ControladorHotel.listaEmpresa()));
    ...
    public boolean asignacionDatos() {
        if (cbxEmpresa.isEnabled()) {
            if (cbxEmpresa.getSelectedIndex() != -1 && cbxReservasPreliminar.getSelectedIndex() != -1
                    && cbxPersona.getSelectedIndex() != -1) {
                if (cbxEmpresa.getItemCount() >= 1 && cbxPersona.getItemCount() >= 1) {
                    tipoClientePaga = 1;
                    clienteSeleccionado = "Reserva: " + cbxReservasPreliminar.getSelectedItem() + "\n"
                            + "Empresa: " + ((Empresa) cbxEmpresa.getSelectedItem()).getNombre() + "\n"
                            + "Encargado de la Paga: " + ((Entidad) cbxPersona.getSelectedItem()).getNombre();
                    return true;
                }
            }
        } else if (cbxAgencia.isEnabled()) {
            if (cbxAgencia.getSelectedIndex() != -1 && cbxReservasPreliminar.getSelectedIndex() != -1) {
                if (cbxAgencia.getItemCount() >= 1 && cbxPersona.getItemCount() >= 1) {
                    tipoClientePaga = 2;
                    clienteSeleccionado = "Reserva: " + cbxReservasPreliminar.getSelectedItem() + "\n"
                            + "Agencia: " + ((Agencia) cbxAgencia.getSelectedItem()).getNombre() + "\n"
                            + "Encargado de la Paga: " + ((Entidad) cbxPersona.getSelectedItem()).getNombre();
                    return true;
                }
            }
        } else if (cbxPersona.isEnabled()) {
            if (cbxPersona.getSelectedIndex() != -1 && cbxReservasPreliminar.getSelectedIndex() != -1) {
                if (cbxPersona.getItemCount() >= 1) {
                    tipoClientePaga = 3;
                    clienteSeleccionado = "Reserva: " + cbxReservasPreliminar.getSelectedItem() + "\n"
                            + "Encargado de la Paga: " + ((Entidad) cbxPersona.getSelectedItem()).getNombre();
                }
    ...
    private javax.swing.JButton btnActualizarFact;
