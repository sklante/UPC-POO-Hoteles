 ...
 * @author operador
 */
public class Agencia extends Entidad{
    
    private String convenio;
    private Medios medioDePago;
    private List<Persona> contacto = new ArrayList<Persona>();
    
    public Agencia(String nombre, Documento documento, String telefono, String correo, Medios medios){
