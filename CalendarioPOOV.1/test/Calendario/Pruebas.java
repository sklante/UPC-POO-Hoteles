...
public class Pruebas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.getColumnModel().getColumn(2).setCellEditor(new ButtonEditor(new JCheckBox("Check")));
    ...
    public void sout(String args) {
        int showInternalConfirmDialog = JOptionPane.showInternalConfirmDialog(this, "Confirmas la accion", "", 1);
    }
