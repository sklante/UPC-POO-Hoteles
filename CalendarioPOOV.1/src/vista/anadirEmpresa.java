 ...
 * @author Pc
 */
public class anadirEmpresa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbxEmpleados.setModel(new javax.swing.DefaultComboBoxModel(ControladorHotel.listaPersonaPorEmpresa(empresa)));
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (validacionCampos()) {
            ...
            empresa = new Empresa(txtNombreEmpresa.getText(),
            ...
            empresa.setConvenio(txtConvenio.getText());
            }
            if (!empresa.getContacto().isEmpty()) {
                ControladorHotel.empresas.add(empresa);
                this.dispose();

            } else {
                JOptionPane.showMessageDialog(null, "Debe anadir al menos a un empleado", "Error ingreso de Datos", 2);
                anadir = new anadirPersona(empresa);
                anadir.setTitle("Agregar empleado a " + empresa.getEmpresa());
    ...
    private void agregarEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarEmpleadoActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(this, "Si crea un empleado, se deberá crear la empresa ¿Desea continuar?") == JOptionPane.OK_OPTION) {
            if (validacionCampos()) {
                if (empresa == null) {
                    Documento documento = new Documento(txtIdentificacion.getText(), (TipoDocumento) cbxTipoDocumento.getSelectedItem());
                    empresa = new Empresa(txtNombreEmpresa.getText(),
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new anadirEmpresa().setVisible(true);
            }
        });
    }
